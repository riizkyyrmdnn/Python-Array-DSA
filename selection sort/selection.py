...
def switch(choice):
    if choice == 1:
        ...
        print(f"After sort: {selection_sort(int_array)}")
    elif choice == 2:
        ...
        print(f"After sort: {selection_sort(float_array)}")
    elif choice == 3:
        ...
        print(f"After sort: {selection_sort(string_array)}")
    else:
        print("0. Close program\n")


if __name__ == "__main__":
    print("___ Selection Sort ___")
